...
const faqs = [
    ...
    { question: "Do you offer customer support?", answer: "Yes, we offer 24/7 customer support via email and chat." },
...
const FaqDropDown = () => {
    ...
    return (
        <div className="my-20  sm:px-6">
            {faqs.map((faq, index) => (
                <div key={index} className="border-b border-gray-300">
                    <button
                        onClick={() => toggleFAQ(index)}
                        className="w-full flex justify-between items-center py-3 sm:py-4 text-base sm:text-lg font-medium focus:outline-none"
                    >
                        {faq.question}
                        {openIndex === index ? (
