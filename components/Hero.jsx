...
const HeroSection = () => {
  return (
    <div className="   bg-black  text-white px-6  pt-10 flex  ">
      <div className='flex flex-col gap-8 flex-1 pb-11 justify-center'>
        ...
        <div className='flex flex-col gap-4'>
          <div className='flex items-center gap-4'>
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="#FF000066" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check-big"><path d="M21.801 10A10 10 0 1 1 17 3.335" /><path d="m9 11 3 3L22 4" /></svg>
