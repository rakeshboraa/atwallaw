...
const Process = () => {
  return (
    <div className='flex flex-col gap-20 mt-[6rem] md:gap-[140px] md:mt-40 px-4 md:px-6 lg:px-0'>
      ...
      <div>
        <div className='w-full md:w-[80%] lg:w-[50%] flex flex-col gap-6 md:gap-10'>
